...
public class ARCBenchmark extends ARCCache<TraceEntry, Content> {
    Metric metric;

    ARCBenchmark(int capacity, AlluxioLoader loader) {
    ...
    public static void main(String[] args) {
        ...
        ARCBenchmark cache = new ARCBenchmark(capacity/unit, loader);
